...
<div>
  ...
  <div id="flowMainCont" class="flow-main-cont" ref="Cont">
    <div style="width:2000px;height:1000px">
      ...
      @dragover.stop.prevent @mousedown="drawLineStart" 
      @mousemove="drawingLine" 
      @mouseup="drawLineEnd" 
      @mousewheel.alt.prevent="wheelHandle" 
      @click.stop.prevent="editEnd"
      >
        <svg id="drawSVG" style="width:1840px; height:1340px; display: block; position: absolute; background-image: none;">
          <defs>
...
export default {
  ...
  computed: {
    ...
    arrowStyle() {
      ...
      //   },
      //   {
      //     top: top * 1 + padding + height - objH / 2 + "px",
      //     left: left - objW / 2 + "px"
      //   },
      //   {
      //     top: top - objH / 2 + "px",
      ...
      //   {
      //     top: top - objH / 2 + "px",
      //     left: left * 1 + width - objH / 2 + padding + "px"
      //   }
      // ];
      // return {
      //   t,
    ...
    resizeStyle() {
      ...
      let w = width / 2;
      let h = height / 2;
      if (this.clickInfo.type === "General") {
        return {
          nw: { x: left - w, y: top - h },
          n: { x: left, y: top - h },
